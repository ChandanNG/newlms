...
<html lang="en">
    ...
    <head>
        ...
        <link type="text/css" href='http://fonts.googleapis.com/css?family=Open+Sans:400italic,600italic,400,600'
            ...
            <style>
                body{
                    background-image:url('images/ssit.jpg');
            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="index.php">WELCOME    <?php
                                ...
                                ?>   <h1 class="card-title"><center><?php echo $name ?></center></h1></a>
